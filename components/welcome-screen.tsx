      ...
      <SafeAreaView
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <View style={{ gap: 6 }}>
              <Text style={[styles.title, { color: scheme.text }]}>Welcome to Budget</Text>
              <Text style={[styles.subtitle, { color: scheme.textMuted }]}>
                A quick tour and one number to get you started.
              </Text>
            </View>
              ...
              {FEATURES.map((f) => (
                <View key={f.title} style={styles.featureRow}>
                  ...
                  <View style={styles.featureBody}>
                    <Text style={[styles.featureTitle, { color: scheme.text }]}>
                      {f.title}
                    </Text>
                  ...
                  return (
                    <Pressable
                      ...
                      <View style={styles.swatchTrio}>
                        <View
                          style={[styles.swatchSm, { backgroundColor: s.background }]}
                        />
                        <View style={[styles.swatchSm, { backgroundColor: s.text }]} />
                        <View
                          style={[styles.swatchSm, { backgroundColor: s.lineChart }]}
                        />
                      </View>
            ...
            <View style={styles.card}>
              ...
              <Pressable
                ...
                <Text
                  style={[
                    ...
                    !amountDigits && styles.balanceAmountMuted,
                  ]}>
              ...
              <Text style={styles.cardHint}>
                Tap the amount to enter what you have on hand. We&apos;ll log it as an
                earned transaction so projections start from the right number.
              </Text>
            </View>
